...
[assembly: EdmRelationshipAttribute("DiNerdDinner.Models", "FK_RSVP_Dinners", "Dinners", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(DiNerdDinner.Models.Dinner), "RSVP", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(DiNerdDinner.Models.RSVP), true)]
...
namespace DiNerdDinner.Models
{
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="DiNerdDinner.Models", Name="Dinner")]
    [Serializable()]
    ...
    public partial class Dinner : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DiNerdDinner.Models", "FK_RSVP_Dinners", "RSVP")]
        public EntityCollection<RSVP> RSVPs
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<RSVP>("DiNerdDinner.Models.FK_RSVP_Dinners", "RSVP");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<RSVP>("DiNerdDinner.Models.FK_RSVP_Dinners", "RSVP", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="DiNerdDinner.Models", Name="RSVP")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class RSVP : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DiNerdDinner.Models", "FK_RSVP_Dinners", "Dinners")]
        public Dinner Dinner
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Dinner>("DiNerdDinner.Models.FK_RSVP_Dinners", "Dinners").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Dinner>("DiNerdDinner.Models.FK_RSVP_Dinners", "Dinners").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<Dinner> DinnerReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Dinner>("DiNerdDinner.Models.FK_RSVP_Dinners", "Dinners");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<Dinner>("DiNerdDinner.Models.FK_RSVP_Dinners", "Dinners", value);
                }
            }
        }
